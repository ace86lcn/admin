<template>
    <div>
		...
		<div class="table-wrap">
			<search placeholder="请输入工资单编号、企业名称、工人姓名搜索"
					@search="handleSearch"
					@reset="handleReset"/>
			<div class="btn">
				<el-button type="primary" @click="remind">一键提醒支付</el-button>
			</div>
				...
				<el-table-column
					...
					<template slot-scope="scope">
						<p class="table-handle">
							<span @click="remindPay(scope.row.payroll_id)">提醒支付</span>
...
<script>
  import { getList, pay } from '../../api/order'
    export default {
        components: {
        },
        data() {
